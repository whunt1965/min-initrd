...
runL:  
	$(QEMU) -nodefaults -enable-kvm -nographic -bios ../seabios/out/bios.bin -kernel $(KERNEL) -initrd min-initrd.d/initrd -hda min-initrd.d/root -serial stdio -append "console=ttyS0 root=/dev/sda nokaslr" -device e1000,netdev=usernet -netdev user,id=usernet,hostfwd=tcp::5555-:5555

debugL:  
	$(QEMU) -nodefaults -s -S -enable-kvm -nographic -bios ../seabios/out/bios.bin -kernel $(KERNEL) -initrd min-initrd.d/initrd -hda min-initrd.d/root -serial stdio -append "console=ttyS0 root=/dev/sda nokaslr" -device e1000,netdev=usernet -netdev user,id=usernet,hostfwd=tcp::5555-:5555

runU:   
	$(QEMU) -nodefaults -nographic -bios ../seabios/out/bios.bin -kernel $(KERNELU) -initrd min-initrd.d/initrd -hda min-initrd.d/root -serial stdio -append "console=ttyS0 root=/dev/sda nokaslr" #-device e1000,netdev=usernet -netdev user,id=usernet,hostfwd=tcp::5555-:5555

debugU: 
	$(QEMU) -nodefaults -s -S -nographic -bios ../seabios/out/bios.bin -kernel $(KERNELU) -initrd min-initrd.d/initrd -hda min-initrd.d/root -serial stdio -append "console=ttyS0 root=/dev/sda nokaslr" -device e1000,netdev=usernet -netdev user,id=usernet,hostfwd=tcp::5555-:5555
